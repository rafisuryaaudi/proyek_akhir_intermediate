...
export async function subscribeToPushNotification(publicKey) {
  if (!('serviceWorker' in navigator)) {
    console.error('Service Worker tidak tersedia di browser ini.');
    return null;
  }
  ...
  try {
    ...
    const subscription = await registration.pushManager.subscribe({
      ...
      applicationServerKey: convertBase64ToUint8Array(publicKey),
    });
